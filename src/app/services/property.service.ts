...
export class PropertyService {
  ...
  private housingsUrl = 'https://9f9rgakshg.execute-api.eu-west-3.amazonaws.com/dev/product-housing/property';

  constructor(private http: HttpClient) {
  }

  getBedTypeByName(name: string): Observable<BedType> {
    return this.http.get<BedType>(this.housingsUrl + '/bedtype?name=' + name).pipe(
  ...
  getBathroomItemByName(name: string): Observable<BathroomItem> {
    return this.http.get<BathroomItem>(this.housingsUrl + '/bathroomitem?name=' + name).pipe(
  ...
  getAllAmenities(): Observable<Amenity[]> {
    return this.http.get<Amenity[]>(this.housingsUrl + '/amenity').pipe(
  ...
  getAllProperties(): Observable<Property[]> {
    return this.http.get<Property[]>(this.housingsUrl).pipe(
  ...
  addBedroom(bedroom: Bedroom): Observable<Bedroom> {
    return this.http.post<Bedroom>(this.housingsUrl + '/bedroom', bedroom, this.httpOptions).pipe(
  ...
  addBathroom(bathroom: Bathroom): Observable<Bathroom> {
    return this.http.post<Bathroom>(this.housingsUrl + '/bathroom', bathroom, this.httpOptions).pipe(
  ...
  createAmenity(amenity: Amenity): Observable<Amenity> {
    return this.http.post<Amenity>(this.housingsUrl + '/amenity', amenity, this.httpOptions).pipe(
